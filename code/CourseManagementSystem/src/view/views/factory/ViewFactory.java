...
public class ViewFactory {
	public static View createView(Response response) {
		if(response instanceof LoginResponse) {
			...
			return new TeacherMainMenu();
		} else if(response instanceof StudentProfileResponse) {
			return new StudentProfileView(((StudentProfileResponse) response).getStudent(), ((StudentProfileResponse) response).getCourses(), ((StudentProfileResponse) response).getEnrollments(), ((StudentProfileResponse) response).getGroup());
